;=#GENERAL INFORMATION # ====================================================================================================================
; Name...........: Rainbow - SoftMax Pro
; Description ...: Rainbow Mainscript starts this script for operating the analysis software SoftMax Pro with the device iD5
; Author ........: Maria Fernanda Avila Vazquez
;Co-Author.......: Nicole Rupp, Jeaninne Opara
;Note............: To the users: Adapt the necessary lines in the following script
...
Sleep(500)
Do
	Global $sumConnect = PixelChecksum(810,446,1105,558)  ;check unti the pixel checksum is x to then click enter
	Sleep(1000)
Until $sumConnect = 4241024597 ;pixel count
Send("{ENTER}")
Sleep(500)
...
;~ Sleep(500)
;~ WinMove("Google Übersetzer - Google Chrome","",1223,451,707,589) ;Move window - casa
;~ Sleep(500)
;~ MouseClick("left",1883,727) ;X-button - casa
;~ Sleep(500)
;~ MouseClick("left",1883,727) ;Field - casa
;~ Sleep(500)
;~ Send("^v");&$sRainbow)
;~ Sleep(500)
;~ MouseClick("left",1302,804) ;Output button - casa
;~ Sleep(500)
;~ Do         ;Pixel function PC casa:
;~ $sum = PixelChecksum(1399,465,1451,490)  ;check unti the pixel checksum is x to then click enter
;~ Sleep(500)
;~ Until $sum = 659625675 ;pixel count
;~ Sleep(500)
;~ MouseClick("left",1883,727) ;Field - casa
WinActivate("Google Übersetzer - Google Chrome")
Sleep(500)
...
;~ WinMove("Google Übersetzer - Google Chrome","",1223,451,707,589)  ;Home PC
;~ Sleep(500)
;~ WinActivate("Google Übersetzer - Google Chrome")
;~ Sleep(500)
;~ MouseClick("left",1883,727) ;X-button - casa
...
;~ MouseClick("left",1883,727) ;Field - casa
;~ Sleep(500)
;~ MouseClick("left",1260,798) ;Input button - casa
;~ Beep(200,500)  ;signal for user
;~ Sleep(8000)
;~ MouseClick("left",1260,798) ;Input button - casa
;~ Sleep(500)
;~ MouseClick("left",1579,730) ;Field - casa
;~ Send("^a") ;Select all
;~ Sleep(500)
;~ Send("^c") ;Copy
...
;~ Sleep(500)
;~ MouseClick("left",1883,727) ;X-button - casa
;~ MouseClick("left",1870,822) ;X-button - lab
;from here lab script
WinActivate("Google Übersetzer - Google Chrome")
...
Send("{ENTER}")
Sleep(500)
;~ MouseClick("left",1296,777) ;Input button - Lab
Beep(200,500)  ;signal for user
Sleep(7000)
Send("{ENTER}")
;~ MouseClick("left",1296,777) ;Input button - Lab
